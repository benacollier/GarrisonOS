...
export function renderErrorPage(
  errorMessage: string = 'An unexpected error occurred while communicating with the GarrisonOS core engine.',
  ...
  return html`
    <div class="card" style="text-align: center; padding: 4rem 2rem; max-width: 640px; margin: 2rem auto;">
      ...
      <p class="text-muted" style="margin-bottom: 1.5rem; line-height: 1.6;">${errorMessage}</p>
      <div style="margin-bottom: 2rem;">
        <span class="badge" style="font-family: monospace; font-size: 0.85rem; padding: 0.35rem 0.75rem;">
          ${errorCode}
        </span>
      </div>
