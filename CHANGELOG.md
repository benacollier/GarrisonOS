...
- Development tooling, background architecture, and attribution guide (`docs/development/tooling-and-attribution.md`) documenting NVIDIA NIM, Ollama, Qwen 2.5 Coder, LLM Worker Tools, Betterleaks, markdownlint, and TypeScript.
