...
CREATE UNIQUE INDEX IF NOT EXISTS idx_je_tenant_entry_number ON journal_entries(tenant_id, entry_number);
CREATE INDEX IF NOT EXISTS idx_je_tenant_date ON journal_entries(tenant_id, date_ms);
...
CREATE INDEX IF NOT EXISTS idx_jl_tenant_account ON journal_lines(tenant_id, account_id, created_at);
CREATE INDEX IF NOT EXISTS idx_jl_tenant_entry ON journal_lines(tenant_id, journal_entry_id);
CREATE INDEX IF NOT EXISTS idx_jl_tenant_property_unit ON journal_lines(tenant_id, property_id, unit_id);
CREATE INDEX IF NOT EXISTS idx_jl_tenant_contact ON journal_lines(tenant_id, contact_id);
...
CREATE INDEX IF NOT EXISTS idx_tx_journal_entry ON transactions(tenant_id, journal_entry_id);
